				...
				<div class="Offer">
					...
					<div class="OfferInclude">
						...
						<div class="col-md-9 Description">
							...
							<br>
							<p>Уважаемые вебмастера, в связи с большим количеством поступивших на эту рекламную кампанию фродовых заказов . Данный оффер будет доступен для работы только со 2-го уровня. Приятной работы. 
</p>
							</div><!--News-->
